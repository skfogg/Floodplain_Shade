...
png("plots/diff_sun_shade_heatmaps_k100_shady_vertical.png", 
    width = 500*5,
...
par(mfrow = c(4,1),
    ...
    cex.axis = 1.5)
for(i in 1:4){
  plot(flip(t(flip(sunshadeDiffRasters[[i]],1)),1),
       asp = 0,
...
png("plots/diff_sun_shade_heatmaps_k400_shady_vertical.png", 
    width = 500*5,
    height = 1000*5, res = 72*5)
par(mfrow = c(4,1),
    mar = c(3,3,1,3),
