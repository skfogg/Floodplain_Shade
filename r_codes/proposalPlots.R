...
setwd("C:/Users/Katie Fogg/Desktop/HGSwork/for_proposal")
...
plot(subset(noatm_mo1, layer == "middle")$y, 
     ...
     col = rgb(col2rgb("cyan")[1]/255, col2rgb("cyan")[2]/255, col2rgb("cyan")[3]/255, alpha = noatm_alpha),
     xlim = c(1000,0), 
     lwd = lwidth,
     ylim = c(-5,30),
     main = "No atmospheric heat exchange",
     xaxt = "n",
     yaxt = "n")
lines(subset(noatm_mo3, layer == "middle")$y, 
      subset(noatm_mo3, layer == "middle")$t, 
      col = rgb(col2rgb("dodgerblue")[1]/255, col2rgb("dodgerblue")[2]/255, col2rgb("dodgerblue")[3]/255, alpha = noatm_alpha),
      lwd = lwidth)
lines(subset(noatm_mo6, layer == "middle")$y, 
      subset(noatm_mo6, layer == "middle")$t, 
      col = rgb(col2rgb("brown1")[1]/255, col2rgb("brown1")[2]/255, col2rgb("brown1")[3]/255, alpha = noatm_alpha),
      lwd = lwidth)
lines(subset(noatm_mo9, layer == "middle")$y, 
      subset(noatm_mo9, layer == "middle")$t, 
      col = rgb(col2rgb("gold")[1]/255, col2rgb("gold")[2]/255, col2rgb("gold")[3]/255, alpha = noatm_alpha),
      lwd = lwidth)
...
lines(subset(shaded_mo1, layer == "middle")$y, 
      subset(shaded_mo1, layer == "middle")$t,
      col = "black", 
      lwd = lwidth,
      lty = 1)
lines(subset(unshaded_mo1, layer == "middle")$y, 
      subset(unshaded_mo1, layer == "middle")$t,
      col = "black", 
      lwd = lwidth,
      lty = 2)
