processAndSave <- function(soil, bc, K, folder = "C:\\Users\\Katie Fogg\\Desktop\\HGSwork\\sensitivity"){
  ...
  saveRDS(timeslist, 
          file = paste0(folderpath, soil, "_", bc, "_rasterlist.RData"))
  saveRDS(velocity, 
          file = paste0(folderpath, foldername, "_velocity.RData"))
  saveRDS(gmeans, 
          file = paste0(folderpath, foldername, "_dailymeans.RData"))
  saveRDS(sat, 
          file = paste0(folderpath, foldername, "_saturation_T1.RData"))
  saveRDS(modelstructure, 
          file = paste0(folderpath, foldername, "_modelstructure.RData"))
}
